...
Follow the below instructions to continue the conversation: 
1. You act as a customer, ask a question based on the chat history.
2. Limit your responses to 1 or 2 sentences and do not use expressions.
...
18. I want you to conclude conversations within five interactions, and the last response should be 'Thanks for your help. Bye.'.
19. Do not say 'Hi' again in the conversation.
20. Do not repeat my questions, just answer them.
...
while (prompt := input("Enter a prompt (q to quit): ")) != "q":
    ...
    refine_prompt = f"You will continue acting as a customer and I will be {human_character} and say to you: '{prompt}'. Do not say 'Hi' again. I will type dialogue and you will response with what the character should say and nothing else. Do not write explanations."
